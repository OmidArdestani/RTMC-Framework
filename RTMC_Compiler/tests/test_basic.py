#!/usr/bin/env python3
"""
Simple test script for RT-Micro-C compiler
...
def test_example_compilation():
    ...
    example_files = list(examples_dir.glob("*.rtmc"))
...
def main():
    """Run all tests"""
    print("=" * 50)
    print("RT-Micro-C Compiler Test Suite")
    print("=" * 50)
    ...
    if passed == total:
        print("🎉 All tests passed! The RT-Micro-C compiler is working correctly.")
        return 0
    else:
