#!/usr/bin/env python3
"""
RT-Micro-C Virtual Machine Runner
Executes bytecode files (.vmb) generated by the RT-Micro-C compiler.
"""
...
def main():
    parser = argparse.ArgumentParser(description='RT-Micro-C Virtual Machine')
